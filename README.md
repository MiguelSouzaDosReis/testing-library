...
Nesse projeto, eu aprendi como testar uma aplicação React de forma eficaz, utilizando diversas técnicas como a criação de mocks de APIs utilizando o fetch, testando inputs e validando fluxos lógicos.  Dentro do arquivo src há o arquivo test contém o código referente aos testes realizados.
...
### fiz todos os requisitos menos o requisito 7
